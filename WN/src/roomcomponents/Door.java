...
public class Door implements Wallable, CheckableForOpenability, Openable , Lockable, Serializable {

    private String name;
    private roomcomponents.Key requestedKey;
    ...
    public Door(String name, boolean isOpen, roomcomponents.Key requestedKey){
        this.name=name;
        this.isOpen = isOpen;
    ...
    public void setRequestedKey(roomcomponents.Key requestedKey) {
        this.requestedKey = requestedKey;
    }

    public String getName() { return name; }
    public roomcomponents.Key getRequestedKey() { return requestedKey; }
