...
public class Chest implements Wallable,CheckableForLockedContent,Lockable, Serializable {

    private String chestName;
    private boolean isOpen;
    private roomcomponents.Key requiredKey;
    private ArrayList<Containable> chestContents;

    public Chest(String chestName, boolean isOpen, roomcomponents.Key requiredKey, ArrayList content){
    ...
    public void setRequiredKey(roomcomponents.Key requiredKey) {
        this.requiredKey = requiredKey;
    }
    ...
    public roomcomponents.Key getRequiredKey() {
        return requiredKey;
    }
